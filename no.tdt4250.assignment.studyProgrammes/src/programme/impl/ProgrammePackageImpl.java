...
import programme.util.ProgrammeValidator;
 ...
 * @generated
 */
public class ProgrammePackageImpl extends EPackageImpl implements ProgrammePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see programme.ProgrammePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ProgrammePackageImpl() {
		super(eNS_URI, ProgrammeFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link ProgrammePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ProgrammePackage init() {
		if (isInited) return (ProgrammePackage)EPackage.Registry.INSTANCE.getEPackage(ProgrammePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredProgrammePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ProgrammePackageImpl theProgrammePackage = registeredProgrammePackage instanceof ProgrammePackageImpl ? (ProgrammePackageImpl)registeredProgrammePackage : new ProgrammePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theProgrammePackage.createPackageContents();

		// Initialize created meta-data
		theProgrammePackage.initializePackageContents();
			...
			(theProgrammePackage,
			 new EValidator.Descriptor() {
				 ...
				 public EValidator getEValidator() {
					 return ProgrammeValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theProgrammePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ProgrammePackage.eNS_URI, theProgrammePackage);
		return theProgrammePackage;
	}
	 ...
	 */
	@Override
	public EAttribute getSemester_Position() {
	 ...
	 */
	@Override
	public EReference getSemester_ProgramCourses() {
	 ...
	 */
	@Override
	public ProgrammeFactory getProgrammeFactory() {
		return (ProgrammeFactory)getEFactoryInstance();
	}
